...
Wenn du wissen möchtest, wie du in anderen Funktionen mit Missings umgehen kannst, schau dir entweder die <span class="r">R</span>-Dokumentation dazu an <font size="2">(unteres rechtes Panel bei Help oder alternativ `?mean`)</font> oder suche im Internet. In unserem Kapitel zu Fehlermeldungen findest du sowohl einen Abschnitt zum Aufbau der [R-Dokumentation](Fehlermeldungen.qmd#span-class-rrspan-dokumentation) sowie einen Abschnitt zum [Suchen im Internet](Fehlermeldungen.qmd#suchen-im-internet). \
