...
> *__Achtung__*:  <div class="rows">Wir sehen nachfolgend auch verdeutlicht, dass `NA` eine selbstständige Kodierung ist, und <u>nicht</u> als <span class="r">character kodiert wird.
...
<div style="text-align: center"><font size="2">**Übersicht der Arten von Missings**</font> 
...
> *__Achtung__*:  <div class="rows">Die Funktion `mcar_test()` kann wir nur mit (quantitativen) Daten des Typs <span class="r">numeric (<span class="r">integer und <span class="r">double), <span class="r">logical und <span class="r">factor umgehen.
...
<!-- \ -->
<!-- > *__Achtung__*:  <div class="rows">Bisher gibt es noch keine Version des Pakets **BaylorEdPsych**, welche unter <span class="r">R 4.0.0 läuft. Im Folgenden sehen wir den Output von `LittleMCAR()` unter **<span class="r">R 3.6.3**. -->
...
Hier vergleichen wir die möglichen Ausprägungen der Variablen, die wir im Codebuch finden, mit den tatsächlichen Ausprägungen der Variablen, die wir uns in <span class="r">R anschauen können.</details>
...
> *__Achtung__*:  <div class="rows">Die Funktion `mcar_test()` kann wir nur mit Variablen des Typs <span class="r">numeric (<span class="r">integer und <span class="r">double), <span class="r">logical und <span class="r">factor umgehen.
