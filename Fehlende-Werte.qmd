...
> *__Achtung__*:  Wir sehen nachfolgend auch verdeutlicht, dass `NA` eine selbstständige Kodierung ist, und <u>nicht</u> als character kodiert wird.
...
<span class ="ex">Vergleichen wir diese Ergebnisse nun mit denen von oben, sehen wir, dass nur der Mittelwert von `Var_3` gleich. Bei den Mittelwerten der beiden anderen Spalten unterscheiden sich die Ergebnisse. 
...
```
table(<span class ="ex">daten$<span class ="ex">Var, useNA='ifany')
```
...
<details><summary>Lösung <font color="#009193">A</summary>
...
<details><summary>Lösung <font color="#009193">B</summary>
...
<details><summary><font color="#009193">Konsequenzen der Verarbeitung von Daten, die MAR oder MNAR sind</summary>
