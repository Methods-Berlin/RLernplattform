...
Zur Überprüfung, ob Aktualisierungen vorhanden sind, können wir in <span class ="r">**R** oben in der Menüleiste auf <span class ="r">**R** --> **Nach **R** Updates suchen** klicken (in **RStudio** gibt es diese Option **nicht**).  
