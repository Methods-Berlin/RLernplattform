...
Was für Informationen wir zu einem Objekt angezeigt bekommen ist abhängig von seiner Datenstruktur. Schauen wir uns das einmal am Beispiel der Objekte, die wir im Abschnitt zu [Daten][Einführung in R](#Daten) im Kapitel [Einführung in R][Einführung in R] erstellt haben, an.
...
Zusätzlich können wir über das <font color="#942192">**Environment**</font> auch externe Datensätze einlesen. Wie wir das machen, schauen wir uns im Kapitel zum [Daten einlesen][Daten importieren] im [Abschnitt dazu][Daten importieren](#Weg 1 Environment Import Dataset) an.
...
Unter <span class="r help">**Files**</span> sehen wir die Ordner(struktur) auf unserem Rechner. Im Kapitel zu [Daten einlesen][Daten importieren] erfahren wir, wie wir [diesen bereich nutzen][Daten importieren](#Weg 2 Files Import Dataset) können.
...
<!-- Mehr Informationen zum **[Aufbau der Dokumentation][Fehlermeldungen](#R Dokumentation)** finden wir im Kapitel **Fehlermeldungen**. -->
