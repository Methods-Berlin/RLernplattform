...
Mehr Informationen zu Datentypen und angemessener Kodierung finden wir im Kapitel [Einführung in R][Einführung in R].
...
Mehr zu Datentypen und -strukturen erfahren wir in [Einführung in R][Einführung in R].
-->
...
Mehr Informationen zum Erstellen von Grafiken mit dem Paket **ggplot2** finden wir im Kapitel zu [Grafiken][Grafiken].\
...
<aside>\
\
Mehr Informationen zu Kodierung gibt es im Kapitel [Einführung in R][Einführung in R].</aside>
