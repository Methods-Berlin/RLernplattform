...
<aside>Die hier durchgeführte Überprüfung ist analog zum [Plausibilitätscheck][[Plausibilitätscheck] im Kapitel zur [Datenvorbereitung][Datenvorbereitung].</aside>
...
<aside>Mehr Informationen zu Datenstrukturen finden wir im Kapitel [Einführung in R][Einführung in R].</aside>
...
\
\
Hier gehts zur [Überprüfung der Unabhängigkeit der Fehlerterme mittels Boxplots][Boxplots der geclusterten Gruppen] aus dem Kapitel zu [Annahmen der Regression][Multiple lineare Regression].</aside>
...
Wenn dieser Abschnitt nicht ausreicht, oder wir mehr zu fehlenden Daten wissen möchtest, können wir uns das detaillierte [Einführungskapitel][Fehlende Werte] dazu anschauen.
...
<aside>[Hier][Fehlende Werte] finden wir das Einführungsskript zu Fehlenden Werten.</aside>
