...
Wenn die Datei neuro.csv erfolgreich eingelesen wurde, erscheint das neu erstellte Objekt neuro <font size="2">(oder welchen anderen Namen wir dem Objekt gegeben haben)</font> im rechten oberen Panel bei **Environment**.
...
<!-- Mit der Funktion `setwd()` setzt man ein Working Directory in R. Dieser Funktion über geben wir den Pfad zu unserem gewünschten Arbeitsordner in Anführungszeichen <font size="2">(`" "` oder `' '`)</font>.  -->
