...
Die ersten beiden Wege nutzen die <span class ="rstud">**grafische Benutzeroberfläche** der Entwicklungsumgebung **RStudio**</span>, letzterer nutzt direkt `Funktionen`.
...
Die grafische Benutzeroberfläche in der Entwicklungsumgebung <span class ="r">**RStudio**</span> ist viel besser ausgebaut (als die des Basisprogramms **R**), weswegen wir diese auch nutzen wollen.</div></details>
...
Für eine ausführlichere Anleitung zum Einlesen von Dateien in `R` gibt es ein eigenständiges [Kapitel](Daten-importieren.qmd), in dem wir lernen, wie wir die Benutzeroberfläche von <span class="r">RStudio</span> und Funktionen nutzen können.
