...
\
Um renv zu nutzen, muss man das Paket einmalig lokal installieren mit `install.packages(renv)`. Wenn das Projekt der RLernplattform anschließend geöffnet wird, werden automatisch die korrekten Versionen installiert. 
\
