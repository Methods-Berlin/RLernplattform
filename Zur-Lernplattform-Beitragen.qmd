...
\
\
Wenn man [hier](#wichtiges Wort) kann man jetzt per Click zurück zu dem wichtigen Wort (und z.B. der Definition) springen.

`<kbd>Taste</kbd>`: Erlaubt es bei Kurzbefehlen die Tasten hervorzuheben.

So kann man bei einem Mac mit <kbd>cmd</kbd> + <kbd>C</kbd> markierten Text kopieren.
