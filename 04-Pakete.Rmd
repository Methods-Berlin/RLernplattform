...
<aside>Hilfe bei der **Installation von Paketen** finden wir im gleichnamigen [Kapitel][Pakete][Pakete].</aside>
...
<aside>Hilfe bei der **Installation von `R` und <span style="font-family: Consolas,monaco,monospace;">RStudio</span>** finden wir unserem [Kapitel][Installation].</aside>
