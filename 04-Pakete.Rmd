...
Bei Problemen mit dem **Installieren bzw. Updaten oder Laden von Paketen** lohnt es sich, in unserem <a href="http://methods-berlin.com/de/r-lernplattform/faq-probleme-pakete" target="_blank">FAQ-Eintrag</a> nachzuschauen.
...
<aside>Hilfe bei der **Installation von Paketen** finden wir im gleichnamigen [Kapitel][Pakete]<a href="http://methods-berlin.com/de/r-lernplattform/pakete" target="_blank">Kapitel</a>.</aside>
...
<aside>Hilfe bei der **Installation von `R` und <span style="font-family: Consolas,monaco,monospace;">RStudio</span>** finden wir unserem <a href="http://methods-berlin.com/de/r-lernplattform/installation" target="_blank">Kapitel</a> dazu.</aside>
