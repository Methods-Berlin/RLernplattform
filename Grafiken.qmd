...
<aside>\
Den [**Violinenplot**] schauen wir uns später noch genauer an.</aside>
...
Das gewünschte **Bildformat** können wir einfach als Endung an den **Namen der Grafik** anhängen. Beides übergeben wir in `" "` an das Argument `filename`.
