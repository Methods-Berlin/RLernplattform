...
<aside>\
Den [**Violinenplot**](#violinenplot) schauen wir uns später noch genauer an.</aside>
...
<aside>\
Bei Problemen beim Installieren bzw. Laden von Paketen schaut in unserem [FAQ-Eintrag](Pakete.qmd#faq) dazu vorbei.</aside>

<details><summary>Cheatsheet zu ggplot2</summary>

Um uns die Anwendung von ggplot2 zu erleichtern, können wir ein Cheatsheet in <a href="https://raw.githubusercontent.com/rstudio/cheatsheets/main/translations/german/data-visualization_de.pdf" target="_blank">deutsch</a> oder <a href="https://raw.githubusercontent.com/rstudio/cheatsheets/main/data-visualization-2.1.pdf" target="_blank">englisch</a> herunterladen. 
...
<details><summary>Beispieldatensatzfür dieses Kapitel</summary>
...
Für den Abschnitt zu Visualisierungsmöglichkeiten bei [mehr als zwei Variablen](#mehr-als-zwei-variablen) nutzen wir zusätzlich noch den Datensatz **mpg**, welcher im Paket **ggplot2** enthalten ist.
...
Bevor wir uns in ggplot2 vertiefen, wollen wir überprüfen, ob unsere Daten in der benötigten [Datenstruktur](Einfuehrung_in_R.qmd#datenstrukturen) vorliegen. Außerdem lernen wir einige Webseiten kennen, die uns dabei helfen, uns für eine Art der Visualisierung unserer Daten zu entscheiden.
...
### Ebene 1: Grundlegendes Koordinatensystem
...
<aside>\
Wir können `aes()` aber nicht nur in `ggplot()`, d.h. dem grundlegenden Koordinatensystem, sondern auch in anderen Ebenen (z.B. `geom_point()`) nutzen.</aside>
...
<aside>\
Hier sehen wir, wie die 1. Ebene, das grundlegende Koordinatensystem `ggplot(...)`, mit der 2. Ebene, den geplotteten Daten `geom_point(...)` durch das `+` verknüpft wurden.</aside>
...
[Später](#kategoriale-variablen-benennung-und-reihenfolge-der-ausprägungen) erfahren wir noch, wie wir die Reihenfolge und Benennung von kategorialen Variablen ändern können.
...
<aside>\
Auf die Integration von Farben, hier durch den Parameter `fill`, gehen wir später im Abschnitt zu [Farbe](#farbe) noch ausführlicher ein.</aside>
...
```
<aside>\
Auf Farben gehen wir im [gleichnamigen Abschnitt](#farbe) später noch ausführlicher ein.</aside>
...
<aside>Wie wir die Datenpunkte in Abhängigkeit einer weiteren kategorialen Variablen einfärben können, erfahren wir im Abschnitt [Farben](#farbe).</aside>
...
<aside>\
Idealerweise würde man vor der Verarbeitung nominal- und ordinalskalierte Variablen, die als numerische Vektoren vorliegen (wie `drv` und `fl`), noch faktorisieren. Mehr dazu auch im Kapitel zu [Datenvorbereitung](Datenvorbereitung.qmd)</aside>

Weitere Informationen zu `facet_grid()`, z.B. wie man hier die Achsengrenzen und -beschriftung anpassen kann, befinden sich auf dem <a href="https://raw.githubusercontent.com/rstudio/cheatsheets/main/translations/german/data-visualization_de.pdf" target="_blank">Cheat Sheet</a>.
...
```{r}
#| echo: !expr F
kable(cont_Chick_alt, escape=FALSE) %>%
  kable_styling(full_width = FALSE, position = "left", c("condensed")) %>%
...
| ---  | -------- | ------------------- |
| fill | ![](figures/ggplot2/Bilder/static fill.png) | ![](figures/ggplot2/Bilder/variable fill.png) |
| col  | ![](figures/ggplot2/Bilder/static col.png)  | ![](figures/ggplot2/Bilder/variable col.png)  |

 
<table width="100%">
    <tr>
        <td width="20%"></td>
        <td width="40%">statisch</td>
        <td width="40%">Variablenausprägung</td>
    </tr>
    <tr>
        <td width="20%">fill</td>
        <td width="40%">![](figures/ggplot2/Bilder/static fill.png)</td>
        <td width="40%">![](figures/ggplot2/Bilder/variable fill.png)</td>
    </tr>
    <tr>
        <td width="20%">col</td>
        <td width="40%">![](figures/ggplot2/Bilder/static col.png)</td>
        <td width="40%">![](figures/ggplot2/Bilder/variable col.png)</td>
    </tr>
</table> 
...
#### Überschrift, Achsenbeschriftung und Bildunterschrift
...
#### Beliebiger Text an beliebiger Stelle
...
> *__Achtung__*:  Etwaige Änderungen der Achsengrenzen müssen wir dann aber auch in `scale_y_continuous(limits)` machen.
