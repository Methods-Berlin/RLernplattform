...
Zusätzlich können wir über das **Environment** auch externe Datensätze einlesen. Wie wir das machen, schauen wir uns im Kapitel zum [Daten einlesen](Daten-importieren.qmd) im [Abschnitt dazu](Daten-importieren.qmd#weg-1-span-class-rstudenvironmentspan--span-class-rstudimport-datasetspan) an.
...
Unter **Files** sehen wir die Ordner(struktur) auf unserem Rechner. Im Kapitel zu [Daten einlesen](Daten-importieren.qmd) erfahren wir, wie wir [diesen bereich nutzen](Daten-importieren.qmd#Weg 2 Files Import Dataset) können.
