...
Den Namen der Funktion geben wir in das <font color="red">Suchfeld ein. Alternativ können wir auch die Funktionen `help(funktion)` oder `?funktion` nutzen. Wenn wir auf <img src="figures/Einführung/Bilder/RStudio/new window.png" style=" width:3%"/> klicken, öffnet sich die Dokumentationsseite in einem neuen Fenster, was die Nutzung wesentlich übersichtlicher gestaltet. 
