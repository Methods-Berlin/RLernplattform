...
table_kat %>%
  ...
  footnote(number = c("Faktorisieren (unordered factor) notwendig <i>wenn</i> keine Indikatorvariable(n) genutzt)","Faktorisieren (ordered factor) notwendig"), general_title = "", escape = FALSE, footnote_as_chunk = TRUE) 
```
