...
Die Funktionsdefinition finden wir in der Dokumentation, welche wir in RStudio unter [Files, Plots, Packages, Help & Viewer](Einfuehrung_in_RStudio.qmd#sec-files-plots-packages-help-viewer).
...
table_kat %>%
  ...
  footnote(general = "<font size=\"1\"><sup>1</sup> Faktorisieren (unordered factor) notwendig <i>wenn</i> keine Indikatorvariable(n) genutzt <sup>2</sup> Faktorisieren (ordered factor) notwendig</font>", general_title = "", escape = FALSE) 
```
