...
Weiterführend ist es sinnvoll, sich die [Einführung in RStudio](Einfuehrung_in_RStudio.qmd) anzuschauen.
...
Die Funktionsdefinition finden wir in der Dokumentation, welche wir in RStudio unter [Files, Plots, Packages, Help & Viewer](Einfuehrung_in_RStudio.qmd#files-plots-packages-help--viewer-sec-files-plots-packages-help-viewer).
...
<aside>Diese Informationen finden wir in der Dokumentation, welche wir unter [help](Einfuehrung_in_RStudio.qmd#files-plots-packages-help--viewer-sec-files-plots-packages-help-viewer) in RStudio ansehen können.</aside>
...
| Operator | Rechenoperationen | Beispiel |
| -------- | ----------------- | -------- |
| -        | Addition          | `1+2 = 3`|
| +        | Subtraktion       | `4-3 = 1`|
| *        | Multiplikation    | `2*3 = 6`|
| /        | Division          | `5/3 = 1.6667` |
| ^ oder ** | Exponenzieren | `8^2 = 64`    |
| %%        | ganzzahliger Rest bei der Division (Modulo)        | `5 %% 3 = 2`    |
| %/%        | ganzzahliger Quotient       | `5 %/% 3 = 1`    |
...
Eine Übersicht weiterer Kurzbefehle für R finden wir in der Leiste ganz oben unter **Help > Keyboard Shortcuts Help** (nicht zu verwechseln mit dem Bereich [help](Einfuehrung_in_RStudio.qmd#files-plots-packages-help--viewer-sec-files-plots-packages-help-viewer), der uns Zugang zur Dokumentation verschafft).
