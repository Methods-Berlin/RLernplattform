...
Den Input übergeben wir an einen Parameter. Das ist eine (formale) *Variable* einer Funktion (z.B. <span class="code">mean(**x**)), die in der Funktionsdefinition festgelegt ist. Der tatsächliche *Input* nennt sich Argument (z.B. <span class="code">mean(x = **nums**)). Die Parameter einer Funktion werden mit Kommata getrennt. Schematisch sieht eine Funktion somit folgendermaßen aus: <span class="code">function(parameter_1 = argument_1, parameter_2 = argument_2, ...)
