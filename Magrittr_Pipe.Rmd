...
Eine Alternative zum base-Pipe-Operator ("|>"), den wir im Crash Course kennengelert haben, ist der am meisten verbreitete magrittr-Pipe-Operator ("%>%") aus dem Paket "magrittr". Der magrittr-Pipe funktioniert sehr ähnlich wie der base-Pipe: 
