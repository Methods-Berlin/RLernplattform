...
```{r, out.width = "700px", echo=FALSE, layout="l-body-outset"}
...
Für eine ausführlichere Anleitung zum Einlesen von Dateien in `R` gibt es ein eigenständiges <a href="http://methods-berlin.com/de/r-lernplattform/daten_einlesen" target="_blank">**Kapitel**</a>, in wir lernen, wie wir die Benutzeroberfläche von <span class="r">RStudio</span> und Funktionen nutzen können.
...
Wenn wir **Hilfe beim Einlesen von Daten** brauchen, können wir uns das ausführliche <a href="http://methods-berlin.com/de/r-lernplattform/daten_einlesen" target="_blank">**Kapitel**</a> dazu anschauen.

Wenn wir **Probleme beim Installieren oder Laden von Paketen** haben, können wir unseren <a href="http://methods-berlin.com/de/r-lernplattform/faq-probleme-pakete" target="_blank">FAQ-Eintrag</a> dazu anschauen.
