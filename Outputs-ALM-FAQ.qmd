...
- `<span style="color:pink> Residual Standard Error </span>`: Standardschätzfehler $s_e$\
Gütemaß für die Genauigkeit der Regressionsvorhersage
- `<span style="color:browm> Multiple R-squared </span>`: Determinationskoeffizient $R^2$\
...
- `<span style="color:blue> Mean Sq`: Mittlere Quadratsumme (MQ)\
