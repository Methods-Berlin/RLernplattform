...
\
> *__Achtung__*:  Bei <span class="code">order(<span class = "ex">X, -<span class = "ex">resid) ändert sich die **Sortierung innerhalb der _gleichen_ Prädiktorwerte X** in Abhängigkeit davon, ob wir bei `order()` vor die *zweite* Variable (<span class="code"><span class = "ex">resid) ein `-` setzen oder nicht:\
