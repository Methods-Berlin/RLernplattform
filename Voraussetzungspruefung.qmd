...
Beispielsweise werden in manchen Anwendungen Missings nicht mit `NA`, sondern z.B. wie bei Unipark mit `99` oder `-99` kodiert. Wir müssen diese *vor* der Auswertung auf `NA` umkodieren, da <span class="r">R</span> diese sonst nicht als Missings erkennt. Für mehr Informationen dazu können wir im [Kapitel zu Fehlenden Werten](Fehlende-Werte.qmd) nachschauen.
